...
def predict():
    ...
    if flask.request.method == "POST":
        ...
        tenure, online_security, phone_service = "", "", ""
        ...
        logger.info(f'{dt} Data: tenure={tenure}, OnlineSecurity={online_security}, PhoneService={phone_service}')
        try:
            preds = model.predict_proba(pd.DataFrame({"tenure": [tenure],
